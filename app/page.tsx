...
export default function Page() {
	...
	return (
		<div className="relative min-h-screen bg-[#fbfcff] text-[#1D0B5B]">
			...
			<main id="top">
				{/* SECTION 1 — HERO */}
				<section className="mx-auto max-w-6xl px-5 sm:px-6 pt-16 sm:pt-20 lg:pt-28 pb-14 sm:pb-16">
					<div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 items-start">
						<motion.div variants={fadeUp} initial="hidden" animate="show" className="lg:col-span-6">
							<h1 className="text-[2.25rem] leading-[1.06] sm:text-5xl md:text-[4rem] font-semibold tracking-[-0.02em] max-w-xl">
								Your booking link.
								<br />
								Your guests.
								<br />
							...
							<p className="mt-5 sm:mt-7 max-w-2xl text-[1rem] sm:text-lg text-slate-700 leading-relaxed">
								A direct booking page for independent hotels and short-stay hosts —
								without commissions or lock‑in.
							</p>
							<div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
								<Button asChild size="lg" data-cta="create-booking-link" className="w-full sm:w-auto justify-center">
								...
								<a
									href="#how"
									className="text-sm font-medium text-[#1D0B5B]/80 hover:text-[#1D0B5B] transition underline underline-offset-4 text-center sm:text-left py-2"
						...
						>
							<figure className="rotate-0 lg:rotate-[-1deg]">
								<div className="mx-auto lg:mx-0 max-w-[360px] sm:max-w-[420px] rounded-[28px] border border-[#1D0B5B]/12 bg-white p-3 shadow-[0_18px_55px_-40px_rgba(29,11,91,0.28)]">
				...
				<div className="mx-auto max-w-6xl px-5 sm:px-6 pb-16 sm:pb-20">
					<motion.figure
						variants={fadeUp}
						initial="hidden"
						whileInView="show"
						viewport={{ once: true, margin: "-80px" }}
						className="mx-auto max-w-[340px] sm:max-w-[420px]"
					>
				...
				{/* SECTION 9 — FINAL CTA */}
				<section id="final" className="mx-auto max-w-6xl px-5 sm:px-6 pt-16 sm:pt-18 pb-20 sm:pb-24">
					<motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }}>
						<h2 className="text-2xl sm:text-3xl font-semibold tracking-tight">
							Set up once.
							<br />
						...
						<div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
							<Button asChild size="lg" data-cta="final-create-booking-link" className="w-full sm:w-auto justify-center">
								<a href="mailto:hello@mybooklinq.com?subject=Booklinq%20%E2%80%94%20Create%20my%20booking%20link">
									Create your booking link <ArrowRight className="h-4 w-4" />
								</a>
							</Button>
